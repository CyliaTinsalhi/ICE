...
public interface StreamApplicationPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default Song[] findByName(String nom)
    {
        return findByName(nom, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Song[] findByName(String nom, java.util.Map<String, String> context)
    {
        return _iceI_findByNameAsync(nom, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Song[]> findByNameAsync(String nom)
    {
        return _iceI_findByNameAsync(nom, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Song[]> findByNameAsync(String nom, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Song[]> _iceI_findByNameAsync(String iceP_nom, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Song[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "findByName", null, sync, null);
        f.invoke(true, context, null, ostr -> {
    ...
    {
        return "::musicapplib::StreamApplication";
    }
}
